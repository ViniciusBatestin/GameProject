...
4. Add lives [2 marks]
	...
	-
	the bottom of the canvas. When this is `true`, decrement the `lives` counter by oneIn this function define a conditional statement that tests if your character has fallen below
